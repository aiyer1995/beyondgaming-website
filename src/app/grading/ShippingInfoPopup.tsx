              ...
              <div>
                ...
                <ul className="space-y-2.5 text-sm text-gray-600">
                  <li className="flex items-start gap-2">
                    ...
                    Share tracking number to: <strong>+91 9909611611</strong> by WhatsApp
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-500 mt-0.5 shrink-0">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    Use a private courier: <strong>Delhivery / DTDC / Blue Dart / Tirupati / Professional Couriers</strong>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-purple-500 mt-0.5 shrink-0">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    Ensure your card is sleeved and packed in a toploader / semi-rigid in a box with plenty of protection.
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    Beyond Grading / Beyond Gaming is <strong>not liable for any damage in transit</strong> so ensure your cards are well packed.
                  </li>
                </ul>
              </div>
