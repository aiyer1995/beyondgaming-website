    ...
    <div class="bg-product-page">
        ...
        <div class="bg-product-page__grid">
            ...
            <div class="bg-product-page__details">
                ...
                <?php // Rip & Ship lives in the bg-rip-and-ship plugin. Guarded so
                      // this template still renders if the plugin is inactive —
                      // a break then falls through to the variable-product link
                      // below rather than fataling the product page. ?>
                <?php elseif (function_exists('bg_rs_is_break') && bg_rs_is_break($product)): ?>
